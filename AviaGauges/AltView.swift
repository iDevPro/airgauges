...
class AltView: GaugesView {
    
    
    required init?(coder aDecoder: NSCoder) {
        super.init(coder: aDecoder)
        self.title = "высотомер"
        configure()
    }
    ...
    func configure() {
        ...
        DataHelper.sharedInstance.addObserver(self, forKeyPath: "indicators", options: NSKeyValueObservingOptions.New, context:
            nil)
    }
